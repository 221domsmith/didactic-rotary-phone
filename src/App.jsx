            ...
            <div style={{ marginTop: 36 }}>
              ...
              <div style={{ background: "#f0ebe0", border: "1px solid #d0c8b4", borderLeft: "3px solid #b8922e", padding: "24px 28px", borderRadius: 2, marginBottom: 32 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 20 }}>
                  {[
                    { icon: "✈️", org: "Major U.S. Airline", role: "Senior RM Analyst", note: "Multi-billion dollar fare portfolio across Pacific Northwest markets" },
                    { icon: "🐠", org: "Major Hospitality Org", role: "Revenue Analyst", note: "Hospitality and attractions revenue strategy, including major exhibit builds" },
                    { icon: "🏦", org: "Regional Financial Institution", role: "Financial Analyst", note: "Consumer finance, lending, and financial strategy" },
                  ].map((item, i) => (
                    <div key={i}>
